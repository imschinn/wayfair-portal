          ...
          <div>
            ...
            <div className="space-y-6">
              {[
                ...
                { icon: Mail, title: "Email", info: "support@wayportal.in", sub: "24 hours mein reply" },
                { icon: MapPin, title: "Address", info: "MG Road, Indore, MP 452001", sub: "India" },
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">Aapka Naam</label>
                      <input type="text" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })}
                        placeholder="Poora naam" required
                  ...
                  <div>
                    ...
                    <textarea value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })}
                      placeholder="Apni baat yahan likhein..." rows={5} required
